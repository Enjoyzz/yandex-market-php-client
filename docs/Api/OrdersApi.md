...
| [**createFaasOrder()**](OrdersApi.md#createFaasOrder) | **POST** /campaigns/{campaignId}/orders | Создание заказа |
...
| [**provideOrderItemIdentifiers()**](OrdersApi.md#provideOrderItemIdentifiers) | **PUT** /campaigns/{campaignId}/orders/{orderId}/identifiers | Передача уникальных кодов маркировки единиц товара |
...
try {
    ...
    echo 'Exception when calling OrdersApi->createFaasOrder: ', $e->getMessage(), PHP_EOL;
}
```
