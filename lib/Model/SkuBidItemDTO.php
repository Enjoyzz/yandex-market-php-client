...
class SkuBidItemDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((!preg_match("/^[\\da-zA-ZА-Яа-я\\.,\/\\\\\\(\\)\\[\\]\\-=_]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling SkuBidItemDTO., must conform to the pattern /^[\\da-zA-ZА-Яа-я\\.,\/\\\\\\(\\)\\[\\]\\-=_]*$/.");
        }
