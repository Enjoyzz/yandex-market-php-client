...
| [**confirmBusinessPrices()**](FbsApi.md#confirmBusinessPrices) | **POST** /businesses/{businessId}/price-quarantine/confirm | Подтверждение цены на товар, попавшего в карантин (основная цена) |
| [**confirmCampaignPrices()**](FbsApi.md#confirmCampaignPrices) | **POST** /campaigns/{campaignId}/price-quarantine/confirm | Подтверждение цены на товар, попавшего в карантин (цена в магазине) |
...
| [**generateMassOrderLabelsReport()**](FbsApi.md#generateMassOrderLabelsReport) | **POST** /reports/documents/labels/generate | Ярлыки‑наклейки на все коробки в нескольких заказах |
...
| [**generateOrderLabels()**](FbsApi.md#generateOrderLabels) | **GET** /campaigns/{campaignId}/orders/{orderId}/delivery/labels | Ярлыки‑наклейки на все коробки в одном заказе |
