...
class OrderDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets items_total
     *
     * @param float|null $items_total Общая сумма заказа в валюте заказа без учета стоимости доставки и вознаграждения партнеру за скидки по промокодам, купонам и акциям.  Для отделения целой части от дробной используется точка.
     *
     * @return self
     */
