...
class MappingsOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setShopSku($shop_sku)
    {
        ...
        if ((!preg_match("/^[\\da-zA-ZА-Яа-я\\.,\/\\\\\\(\\)\\[\\]\\-=_]*$/", ObjectSerializer::toString($shop_sku)))) {
            throw new \InvalidArgumentException("invalid value for \$shop_sku when calling MappingsOfferDTO., must conform to the pattern /^[\\da-zA-ZА-Яа-я\\.,\/\\\\\\(\\)\\[\\]\\-=_]*$/.");
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[\\da-zA-ZА-Яа-я\\.,\/\\\\\\(\\)\\[\\]\\-=_]*$/", ObjectSerializer::toString($id)))) {
